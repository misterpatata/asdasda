...
$length_for_random_letters = 3;

$randomletter = substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"), 0, $length_for_random_letters);

$length_for_random_numbers = 3;

$randomnumber = substr(str_shuffle("1234567890"), 0, $length_for_random_numbers);
...
<form class="" style="margin-top:300px;margin-left:200px" method="post" action="https://www.apple.com/" >
